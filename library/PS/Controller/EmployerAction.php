<?php
class PS_Controller_EmployerAction extends Zend_Controller_Action {
    ...
    function doAdminAuthorisation() {
        ...
        if(!isset($objSess->isUserLogin) || $objSess->isUserLogin != true || $objSess->user_type != '2')
        {
