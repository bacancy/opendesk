...
class Agency_JobController extends PS_Controller_AgencyAction 
{
    ...
    public function indexAction() 
    {
        ...
        $this->view->siteTitle = $objTranslate->translate ( 'Agency - jobs' );
    ...
    public function addAction() 
    {
        ...
        $objSess = new Zend_Session_Namespace(PS_App_Auth);
        $objRequest = $this->getRequest();                        
        $this->view->siteTitle = $objTranslate->translate('agency - post Job');                
        ...
        if ($objRequest->isPost ()) {
            $formData = $objRequest->getPost ();
            if ($objForm->isValid ( $formData )) {                                                
                //here employee_id means "At this time agency can treat as a employee".
                ...
                if($isvalid){                                                                                                                        
                    ...
                    $this->_redirect("/agency/job/index");
                }
            }else {	
    ...
    public function editAction() 
    {
        ...
        $objSess = new Zend_Session_Namespace(PS_App_Auth);
        $objRequest = $this->getRequest();                        
        $this->view->siteTitle = $objTranslate->translate('Agency - edit job');
