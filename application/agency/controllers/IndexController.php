 ...
 */
class Agency_IndexController extends PS_Controller_AgencyAction 
{
    ...
    public function indexAction() 
    {
        ...
        $this->view->siteTitle = $objTranslate->translate('Agency');
    ...
    public function profileAction() 
    {
        ...
        $profileData = $objModel->getUserInfo($objSess->user_id);
        
        
		$timespam = strtotime($profileData['modified']);
		$profileData['modified'] = date("D, M dS Y");
		//echo "<pre>";
		//print_r($profileData['modified']);exit;
        ...
        if ($objRequest->isPost ()) {
            ...
            if ($objForm->isValid ( $formData )) {                                                
                ...
                if($isvalid){                                                                                                                        
                    ...
                    $this->_redirect("/agency/index/profile");
                }
            }else {	
