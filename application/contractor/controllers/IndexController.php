 ...
 */
class Contractor_IndexController extends PS_Controller_ContractorAction 
{
    ...
    public function indexAction() 
    {
        ...
        $this->view->siteTitle = $objTranslate->translate('Contractor');
    ...
    public function profileAction() 
    {
        ...
        $profileData = $objModel->getContractorInfo($objSess->user_id);
        $contractData = $objModel->getContractorContractsInfo($objSess->user_id);
        ...
        if ($objRequest->isPost ()) {
            ...
            if ($objForm->isValid ( $formData )) {                                                                
                ...
                if($isvalid){                                                                                                                        
                    ...
                    $this->_redirect("/contractor/index/profile");
                }
            }else {	
